...
enum ImGuiGradientFlags_ {
    ...
    ImGuiGradientFlags_NoComboAndRandomMode   = ImGuiGradientFlags_NoRandomModeChange | ImGuiGradientFlags_NoCombo,
    ImGuiGradientFlags_NoButtonAndMarkOptions = ImGuiGradientFlags_NoAddAndRemoveButton | ImGuiGradientFlags_NoMarkOptions,
};