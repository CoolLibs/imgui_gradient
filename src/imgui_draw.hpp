...
void draw_gradient(Gradient& gradient, ImDrawList& draw_list, const Interpolation& interpolation_mode, const ImVec2 gradient_bar_pos, const float gradient_bar_bottom, float width);
